...
def main():
    ...
    while not done:
       ...
       # print "frame clock---->",frame_clock,curr_flag,flag
        if frame_clock%5==0 and curr_flag:                  #-------current state loop-----------------------
